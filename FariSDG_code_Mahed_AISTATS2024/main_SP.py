...
model_1 = utils.supervised_model_training(trainX, trainY, 'logisticregression')
trainX1 = copy.deepcopy(trainX)
testX1 = copy.deepcopy(testX)
trainX1[:,60:62] = 0
testX1[:,60:62] = 0

model_2 = utils.supervised_model_training(trainX1, trainY, 'logisticregression')
...
print("The performance on real data is:", pre_r, rec_r, auc_r, "\nThe performance on synthetic data is:", per_s, rec_s,
      auc_s)
print("\nAlso accuracy for real is: ", utils.metrics.accuracy_score(testY, model.predict(testX)))
print("\nAnd accuracy for syn is: ", utils.metrics.accuracy_score(testY, model_s.predict(testX)))
